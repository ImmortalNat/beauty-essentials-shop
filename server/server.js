...
const DEFAULT_DELIVERY = [
  ...
  { id: 6, region: "Greater Accra", town: "Tema / Ashaiman", fee: 40 },
  { id: 7, region: "Ashanti", town: "Kumasi Central (Adum / Asafo)", fee: 45 },
  { id: 8, region: "Ashanti", town: "KNUST / Ayigya", fee: 50 },
  { id: 9, region: "Western", town: "Takoradi Central", fee: 55 },
  { id: 10, region: "Central", town: "Cape Coast / UCC", fee: 50 },
  { id: 11, region: "Eastern", town: "Koforidua Central", fee: 45 },
  { id: 12, region: "Northern", town: "Tamale Central", fee: 65 }
];
...
async function initDb() {
  ...
  try {
    ...
    if (Number((await pool.query('SELECT COUNT(*) FROM delivery')).rows[0].count) === 0) {
      for (const d of DEFAULT_DELIVERY) await pool.query('INSERT INTO delivery (id, region, town, fee) VALUES ($1,$2,$3,$4) ON CONFLICT DO NOTHING', [d.id, d.region, d.town, d.fee]);
    }
